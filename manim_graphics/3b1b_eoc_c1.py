...
class PreviewFrame(Scene):
    def construct(self):
        ...
        titles = [
            MathTex("Chapter %d:"%d, s).to_edge(UP).set_color(next(colors))
            for d, s in [
...
class ApproximateOneRing(CircleScene, ReconfigurableScene):
    ...
    def isolate_one_ring(self):
        ...
        area_q = MathTex("Area", "?", arg_separator = "")
    ...
    def straighten_ring_out(self):
        ring = self.ring.copy()
        trapezoid = MathTex("Trapezoid?")
        rectangle_ish = MathTex("Rectangle-ish")
...
class GraphRectangles(CircleScene, GraphScene):
    ...
    def draw_r_values(self):
        values_of_r = MathTex("Values of ", "$r$")
    ...
    def point_out_approximation(self):
        ...
        rect.save_state()
        approximation = MathTex("= Approximation")
...
class RecapCircleSolution(GraphRectangles, ReconfigurableScene):
    ...
    def break_up_circle(self):
        ...
        hard_problem = MathTex("Hard problem")
        down_arrow = Tex("\\Downarrow")
        sum_words = MathTex("Sum of many \\\\ small values")
    ...
    def full_precision(self):
        words = MathTex("Area under \\\\ a graph")
...
class AreaUnderParabola(GraphScene):
    ...
    def name_integral(self):
        ...
        words = MathTex("``Integral'' of ", f_tex)
...
class AlternateAreaUnderCurve(PlayingTowardsDADX):
    ...
    def name_derivative(self):
        deriv_words = MathTex("``Derivative'' of $A$")
